...
bot.on("voiceChannelJoin", (member, newChannel) => {
  ...
  bot.createMessage('510283280369582080', member.username + "が チャンネル[" + newChannel.name + "] に入室しました");
});
...
bot.on("voiceChannelLeave", (member, oldChannel) => {
  ...
  bot.createMessage('510283280369582080', member.username + "が チャンネル[" + oldChannel.name + "] を退室しました。");
});
